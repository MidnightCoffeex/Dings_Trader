  ...
  return (
    <AppShell>
      <div className="space-y-6">
        <PageHeader title="Konfiguration" subtitle="Verwaltung der Symbiose-Parameter und Risiko-Limits." />
        ...
        <div className="grid gap-4 lg:grid-cols-3">
          ...
          <Card className="bg-card/40">
            <CardHeader>
              <CardTitle className="text-sm font-medium text-muted-foreground">Risiko-Parameter</CardTitle>
            </CardHeader>
            <CardContent className="space-y-3">
              ...
              <Button variant="outline" className="w-full">Limits anpassen</Button>
            </CardContent>
          </Card>
        </div>
      </div>
