  ...
  return (
    <AppShell>
      <div className="space-y-6">
        <PageHeader title="Synthese-Hirn" subtitle="Trainingsstatus, Versionierung und Inferenz-Gesundheit." />

        <div className="grid gap-4 lg:grid-cols-3">
          <Card className="bg-card/40 lg:col-span-2 border-primary/20">
            <CardHeader className="flex-row items-center justify-between">
              <CardTitle className="text-sm font-medium text-muted-foreground">Aktive Intelligenz</CardTitle>
            ...
            <CardContent className="space-y-4">
              <div className="grid gap-3 sm:grid-cols-3">
                {[
                  ...
                  <div key={x.k} className="rounded-md border border-border/70 bg-background/30 p-3">
          ...
          <Card className="bg-card/40">
            <CardHeader>
              <CardTitle className="text-sm font-medium text-muted-foreground">Steuerung</CardTitle>
            </CardHeader>
            <CardContent className="space-y-2">
              <Button className="w-full">Retraining starten</Button>
              <Button className="w-full" variant="outline">Eval-Suite (Strict Split)</Button>
              <Button className="w-full" variant="secondary">Modell-Snapshot sichern</Button>
            </CardContent>
          </Card>
        </div>
      </div>
